...
img_path= args['image'] if args['image'] is not None else 'data/edge-detection/sample-09.png'
...
fc_bgr_building_yellow= (137,239,246) 
# 212, 237, 253
# 210, 227, 239 | 215, 238, 253
fc_bgr_building_gray= (237,237,237)
...
fc_hsv_building_gray_darker= (fc_hsv_building_gray[0]+10 , fc_hsv_building_gray[1]+10, fc_hsv_building_gray[2]+10)
...
json_contour_filepath= os.path.join(BASE_DIR, img_base_results_path+img_name+'-contours-method-3-mod-carto-gs.json')
json_contour_debug_filepath= os.path.join(BASE_DIR, img_base_results_path+img_name+'-contours-method-3-mod-carto-gs-debug.json')
geojson_filepath= os.path.join(BASE_DIR, img_base_results_path+img_name+'-method-3-mod-carto-gs-geojson.json')
...
cv2.imwrite(os.path.join(BASE_DIR, result_ftemplate.replace('<fnm>','method-3-mod-carto-gs-step-1-1-hsv-building-yellow')), fc_hsv_building_yellow)
cv2.imwrite(os.path.join(BASE_DIR, result_ftemplate.replace('<fnm>','method-3-mod-carto-gs-step-1-2-hsv-building-gray')), fc_hsv_building_gray)
cv2.imwrite(os.path.join(BASE_DIR, result_ftemplate.replace('<fnm>','method-3-mod-carto-gs-step-2-image-bgr')), image)
cv2.imwrite(os.path.join(BASE_DIR, result_ftemplate.replace('<fnm>','method-3-mod-carto-gs-step-3-image-rgb')) , img_rgb)
cv2.imwrite(os.path.join(BASE_DIR, result_ftemplate.replace('<fnm>','method-3-mod-carto-gs-step-4-0-hsv')), hsv)
cv2.imwrite(os.path.join(BASE_DIR, result_ftemplate.replace('<fnm>','method-3-mod-carto-gs-step-4-1-hsv-mask-yellow')), mask_yellow)
cv2.imwrite(os.path.join(BASE_DIR, result_ftemplate.replace('<fnm>','method-3-mod-carto-gs-step-4-2-hsv-mask-gray')), mask_gray)
cv2.imwrite(os.path.join(BASE_DIR, result_ftemplate.replace('<fnm>','method-3-mod-carto-gs-step-5-final')), final)
cv2.imwrite(os.path.join(BASE_DIR, result_ftemplate.replace('<fnm>','method-3-mod-carto-gs-step-6-image-gray')), final_gray)
cv2.imwrite(os.path.join(BASE_DIR, result_ftemplate.replace('<fnm>','method-3-mod-carto-gs-step-7-final-blurred')), final_blurred)
cv2.imwrite(os.path.join(BASE_DIR, result_ftemplate.replace('<fnm>','method-3-mod-carto-gs-step-8-final-thresh')), final_thresh)
cv2.imwrite(os.path.join(BASE_DIR, result_ftemplate.replace('<fnm>','method-3-mod-carto-gs-step-9-image-final-with-contours')), final_wctrs)
