...
fc_bgr_building_yellow= (241,250,255)
...
fc_hsv_building_yellow_darker= (fc_hsv_building_yellow[0]+35 , fc_hsv_building_yellow[1]+35, fc_hsv_building_yellow[2]+35)
...
json_contour_filepath= os.path.join(BASE_DIR, img_base_results_path+img_name+'-contours-method-3-mod-gmaps.json')
json_contour_debug_filepath= os.path.join(BASE_DIR, img_base_results_path+img_name+'-contours-method-3-mod-gmaps-debug.json')
geojson_filepath= os.path.join(BASE_DIR, img_base_results_path+img_name+'-method-3-mod-gmaps-geojson.json')
...
cv2.imwrite(os.path.join(BASE_DIR, result_ftemplate.replace('<fnm>','method-3-mod-gmaps-step-1-1-hsv-building-yellow')), fc_hsv_building_yellow)
cv2.imwrite(os.path.join(BASE_DIR, result_ftemplate.replace('<fnm>','method-3-mod-gmaps-step-1-2-hsv-building-gray')), fc_hsv_building_gray)
cv2.imwrite(os.path.join(BASE_DIR, result_ftemplate.replace('<fnm>','method-3-mod-gmaps-step-2-image-bgr')), image)
cv2.imwrite(os.path.join(BASE_DIR, result_ftemplate.replace('<fnm>','method-3-mod-gmaps-step-3-image-rgb')) , img_rgb)
cv2.imwrite(os.path.join(BASE_DIR, result_ftemplate.replace('<fnm>','method-3-mod-gmaps-step-4-0-hsv')), hsv)
cv2.imwrite(os.path.join(BASE_DIR, result_ftemplate.replace('<fnm>','method-3-mod-gmaps-step-4-1-hsv-mask-yellow')), mask_yellow)
cv2.imwrite(os.path.join(BASE_DIR, result_ftemplate.replace('<fnm>','method-3-mod-gmaps-step-4-2-hsv-mask-gray')), mask_gray)
cv2.imwrite(os.path.join(BASE_DIR, result_ftemplate.replace('<fnm>','method-3-mod-gmaps-step-5-final')), final)
cv2.imwrite(os.path.join(BASE_DIR, result_ftemplate.replace('<fnm>','method-3-mod-gmaps-step-6-image-gray')), final_gray)
cv2.imwrite(os.path.join(BASE_DIR, result_ftemplate.replace('<fnm>','method-3-mod-gmaps-step-7-final-blurred')), final_blurred)
cv2.imwrite(os.path.join(BASE_DIR, result_ftemplate.replace('<fnm>','method-3-mod-gmaps-step-8-final-thresh')), final_thresh)
cv2.imwrite(os.path.join(BASE_DIR, result_ftemplate.replace('<fnm>','method-3-mod-gmaps-step-9-image-final-with-contours')), final_wctrs)
