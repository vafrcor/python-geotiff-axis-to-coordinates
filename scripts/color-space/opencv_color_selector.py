...
# image_path = "hsv.jpg"
# image_path = os.path.join(BASE_DIR, "scripts/color-space/HSV.JPG")
# image_path = os.path.join(BASE_DIR, "data/edge-detection/sample-03.jpg")
image_path = os.path.join(BASE_DIR, "data/edge-detection/sample-11.png")
